...
ASM_FUNC("__Z11utf816_sizePKc@4", "pushl %esi; pushl %ebx;movl 12(%esp), %esi;"
	"xorl %ebx, %ebx; 1: movzbl (%esi), %eax; inc %ebx; inc %esi; testb %al, %al;"
	"js 2f; jne 1b; movl %ebx, %eax; popl %ebx; popl %esi; addl %eax,%eax; ret $4;"
	"2: call _UTF8_GET1; shrl $16, %eax; je 1b; inc %ebx; jmp 1b" );
ASM_FUNC("__Z11utf816_sizePKci@8", "pushl %ebx; pushl %ebp; xorl %ebx, %ebx; pushl %esi;"
	"movl 20(%esp), %ebp; movl 16(%esp), %esi; addl %esi, %ebp; 1: inc %ebx; "
	"cmpl %ebp, %esi; jae 3f; movzbl (%esi), %eax; inc %esi; testb %al, %al; jns 1b;"
	"movl %ebp, %edx; call _UTF8_GET2; shrl $16, %eax; je 1b; inc %ebx; jmp 1b; "
	"3: popl %esi; popl %ebp; movl %ebx, %eax; popl %ebx; addl %eax,%eax; ret $8;" ); 
...
ASM_FUNC("__Z10utf816_cpyPwPKci@12", "pushl %edi; pushl %ebp; pushl %esi; "
	"movl 24(%esp), %ebp; movl 20(%esp), %esi; movl 16(%esp), %edi; addl %esi, %ebp;"
	"jmp 1f; 0: stosw; 1: cmpl %ebp, %esi; jae 3f; movzbl (%esi), %eax; inc %esi;"
	"testb %al, %al; jns 0b; movl %ebp, %edx; call _UTF8_GET2; call _UTF16_PUT1;"
	"jmp 1b; 3: popl %esi; popl %ebp; movl %edi, %eax; movw $0, (%edi); popl %edi; ret $12;" );
